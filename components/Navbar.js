...
export default function Navbar() {
 ...
 if(isHovered == false) {
  ...
  <ul className="flex justify-center relative flex-col   sm:items-center items-start space-y-10   mt-2 " >
    <li key={1} className='font-medium sm:text-2xl text-xl hover:text-4xl hover:transition-all transition-transform capitalize text-white '> home</li>
    <li key={1} className='font-normal sm:text-2xl text-xl capitalize text-white '>the product</li>
    <li key={1} className='font-normal sm:text-2xl text-xl capitalize text-white '> customers </li>
    <li key={1}className='font-normal sm:text-2xl text-xl capitalize text-white '> contact us </li>
  </ul>
